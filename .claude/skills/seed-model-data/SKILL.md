...
3. Find the API base URL from the project's launch settings. Prefer the HTTPS URL when both HTTP and HTTPS are available locally.
...
6. Inspect EF configuration,model validators and application handlers for unique constraints or cross-field/business rules. Generate values that satisfy them.
